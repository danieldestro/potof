...
INSERT IGNORE INTO categorias (id, slug, nome, ativo, created_at, updated_at) VALUES
  (81, 'aeromodelismo', 'Aeromodelismo', 1, NOW(), NOW()),
  (82, 'altinha', 'Altinha', 1, NOW(), NOW()),
  (83, 'apneia', 'Apneia', 1, NOW(), NOW()),
  (84, 'aquathlon', 'Aquathlon', 1, NOW(), NOW()),
  (85, 'arremessodepeso', 'Arremesso de Peso', 1, NOW(), NOW()),
  (86, 'automobilismo', 'Automobilismo', 1, NOW(), NOW()),
  (87, 'balonismo', 'Balonismo', 1, NOW(), NOW()),
  (88, 'biathlon', 'Biathlon', 1, NOW(), NOW()),
  (89, 'bmx', 'BMX', 1, NOW(), NOW()),
  (90, 'bocha', 'Bocha', 1, NOW(), NOW()),
  (91, 'bodyboard', 'Bodyboard', 1, NOW(), NOW()),
  (92, 'boiacross', 'Bóia Cross', 1, NOW(), NOW()),
  (93, 'boxe', 'Boxe', 1, NOW(), NOW()),
  (94, 'bungeejump', 'Bungee Jump', 1, NOW(), NOW()),
  (95, 'calistenia', 'Calistenia', 1, NOW(), NOW()),
  (96, 'cambio', 'Cambio', 1, NOW(), NOW()),
  (97, 'caminhada', 'Caminhada', 1, NOW(), NOW()),
  (98, 'canicross', 'Canicross', 1, NOW(), NOW()),
  (99, 'canionismo', 'Canionismo', 1, NOW(), NOW()),
  (100, 'canoahavaiana', 'Canoa Havaiana', 1, NOW(), NOW()),
  (101, 'canoapolinesia', 'Canoa Polinésia', 1, NOW(), NOW()),
  (102, 'carrinhoderolima', 'Carrinho de Rolimã', 1, NOW(), NOW()),
  (103, 'cicloturismo', 'Cicloturismo', 1, NOW(), NOW()),
  (104, 'corridadeorientacao', 'Corrida de Orientação', 1, NOW(), NOW()),
  (105, 'corridaemesteira', 'Corrida em Esteira', 1, NOW(), NOW()),
  (106, 'corridapet', 'Corrida Pet', 1, NOW(), NOW()),
  (107, 'crosscountry', 'Cross Country', 1, NOW(), NOW()),
  (108, 'dirtjump', 'Dirt Jump', 1, NOW(), NOW()),
  (109, 'downhil', 'Downhil', 1, NOW(), NOW()),
  (110, 'duathlon', 'Duathlon', 1, NOW(), NOW()),
  (111, 'entregadekit', 'Entrega de Kit', 1, NOW(), NOW()),
  (112, 'escalada', 'Escalada', 1, NOW(), NOW()),
  (113, 'esgrima', 'Esgrima', 1, NOW(), NOW()),
  (114, 'esportessubaquatico', 'Esportes Subaquático', 1, NOW(), NOW()),
  (115, 'esqui', 'Esqui', 1, NOW(), NOW()),
  (116, 'eventomultiesporte', 'Evento Multiesporte', 1, NOW(), NOW()),
  (117, 'finswimming', 'Finswimming', 1, NOW(), NOW()),
  (118, 'fitdance', 'Fitdance', 1, NOW(), NOW()),
  (119, 'flagfootball', 'Flag Football', 1, NOW(), NOW()),
  (120, 'freediving', 'Freediving', 1, NOW(), NOW()),
  (121, 'frescobol', 'Frescobol', 1, NOW(), NOW()),
  (122, 'futebol7', 'Futebol 7', 1, NOW(), NOW()),
  (123, 'futebolsociety', 'Futebol Society', 1, NOW(), NOW()),
  (124, 'futmesa', 'Futmesa', 1, NOW(), NOW()),
  (125, 'ginasticaacrobatica', 'Ginástica Acrobática', 1, NOW(), NOW()),
  (126, 'ginasticaaerobica', 'Ginástica Aeróbica', 1, NOW(), NOW()),
  (127, 'ginasticaolimpica', 'Ginástica Olímpica', 1, NOW(), NOW()),
  (128, 'ginasticaritmica', 'Ginástica Rítmica', 1, NOW(), NOW()),
  (129, 'gravel', 'Gravel', 1, NOW(), NOW()),
  (130, 'halterofilismo', 'Halterofilismo', 1, NOW(), NOW()),
  (131, 'hiking', 'Hiking', 1, NOW(), NOW()),
  (132, 'jogosescolares', 'Jogos Escolares', 1, NOW(), NOW()),
  (133, 'kangoo', 'Kangoo', 1, NOW(), NOW()),
  (134, 'kart', 'Kart', 1, NOW(), NOW()),
  (135, 'kettlebellsport', 'Kettlebell Sport', 1, NOW(), NOW()),
  (136, 'kickboxing', 'Kickboxing', 1, NOW(), NOW()),
  (137, 'lacocomprido', 'Laço Comprido', 1, NOW(), NOW()),
  (138, 'lacoemdupla', 'Laço em Dupla', 1, NOW(), NOW()),
  (139, 'levantamentodepesoolimpico', 'Levantamento de peso olímpico', 1, NOW(), NOW()),
  (140, 'lifesaving', 'Lifesaving', 1, NOW(), NOW()),
  (141, 'livrepodecadastraresporte', 'Livre - Pode cadastrar esporte', 1, NOW(), NOW()),
  (142, 'luta', 'Luta', 1, NOW(), NOW()),
  (143, 'maratonaaquatica', 'Maratona Aquática', 1, NOW(), NOW()),
  (144, 'marchaatletica', 'Marcha Atlética', 1, NOW(), NOW()),
  (145, 'mma', 'MMA', 1, NOW(), NOW()),
  (146, 'montanhismo', 'Montanhismo', 1, NOW(), NOW()),
  (147, 'motovelocidade', 'Motovelocidade', 1, NOW(), NOW()),
  (148, 'mountainbike', 'Mountain Bike', 1, NOW(), NOW()),
  (149, 'mtb', 'MTB', 1, NOW(), NOW()),
  (150, 'musculacao', 'Musculação', 1, NOW(), NOW()),
  (151, 'natacaocorrida', 'Natação / Corrida', 1, NOW(), NOW()),
  (152, 'natacaoempiscina', 'Natação em Piscina', 1, NOW(), NOW()),
  (153, 'offroad', 'Off-Road', 1, NOW(), NOW()),
  (154, 'passeiociclistico', 'Passeio Ciclístico', 1, NOW(), NOW()),
  (155, 'pedal', 'Pedal', 1, NOW(), NOW()),
  (156, 'pendulo', 'Pêndulo', 1, NOW(), NOW()),
  (157, 'pentatlomoderno', 'Pentatlo moderno', 1, NOW(), NOW()),
  (158, 'pescasubmarina', 'Pesca submarina', 1, NOW(), NOW()),
  (159, 'poker', 'Poker', 1, NOW(), NOW()),
  (160, 'punhobol', 'Punhobol', 1, NOW(), NOW()),
  (161, 'queimada', 'Queimada', 1, NOW(), NOW()),
  (162, 'rapelropejumptirolesa', 'Rapel / Rope jump / Tirolesa', 1, NOW(), NOW()),
  (163, 'remo', 'Remo', 1, NOW(), NOW()),
  (164, 'rockjump', 'Rock Jump', 1, NOW(), NOW()),
  (165, 'snookersinuca', 'Snooker/Sinuca', 1, NOW(), NOW()),
  (166, 'squash', 'Squash', 1, NOW(), NOW()),
  (167, 'stockcar', 'Stock Car', 1, NOW(), NOW()),
  (168, 'supstanduppaddle', 'SUP - Stand Up Paddle', 1, NOW(), NOW()),
  (169, 'taekwondo', 'Taekwondo', 1, NOW(), NOW()),
  (170, 'tiro', 'Tiro', 1, NOW(), NOW()),
  (171, 'torcidas', 'Torcidas', 1, NOW(), NOW()),
  (172, 'torcidasdefutebol', 'Torcidas de Futebol', 1, NOW(), NOW()),
  (173, 'trailrun', 'Trail Run', 1, NOW(), NOW()),
  (174, 'trainingcamp', 'Training Camp', 1, NOW(), NOW()),
  (175, 'treinamentofuncional', 'Treinamento Funcional', 1, NOW(), NOW()),
  (176, 'treinosof', 'Treinos OF', 1, NOW(), NOW()),
  (177, 'trekkingtrilhas', 'Trekking / Trilhas', 1, NOW(), NOW()),
  (178, 'trestambores', 'Três Tambores', 1, NOW(), NOW()),
  (179, 'ultramaratona', 'Ultramaratona', 1, NOW(), NOW()),
  (180, 'vaquejada', 'Vaquejada', 1, NOW(), NOW()),
  (181, 'vela', 'Vela', 1, NOW(), NOW()),
  (182, 'velocross', 'Velocross', 1, NOW(), NOW()),
  (183, 'voleidepraia', 'Vôlei de Praia', 1, NOW(), NOW()),
  (184, 'voolivre', 'Voo Livre', 1, NOW(), NOW()),
  (185, 'wakeboard', 'Wakeboard', 1, NOW(), NOW()),
  (186, 'windsurf', 'Windsurf', 1, NOW(), NOW()),
  (187, 'wrestling', 'Wrestling', 1, NOW(), NOW());
