...
// Categorias novas introduzidas por este provedor (id sequencial, pós-seed do Fotop). `icone`
// (quando presente) é o caminho do SVG self-hosted em frontend/public/categoria-icons/,
// baixado do catálogo de ícones de esporte do modal de filtros do focoradical.com.br — essas
// categorias não têm glifo na fonte fi-estacao (que só cobre a taxonomia original do Fotop, ver
// categoriaSeedData.ts), então ficariam sem ícone algum sem isso.
export const FOCO_RADICAL_NOVAS_CATEGORIAS: { id: number; slug: string; nome: string; icone?: string }[] = [
  { id: 81, slug: 'aeromodelismo', nome: 'Aeromodelismo' },
  { id: 82, slug: 'altinha', nome: 'Altinha' },
  { id: 83, slug: 'apneia', nome: 'Apneia' },
  { id: 84, slug: 'aquathlon', nome: 'Aquathlon', icone: '/categoria-icons/aquathlon.svg' },
  { id: 85, slug: 'arremessodepeso', nome: 'Arremesso de Peso', icone: '/categoria-icons/arremesso-de-peso.svg' },
  { id: 86, slug: 'automobilismo', nome: 'Automobilismo', icone: '/categoria-icons/stock-car.svg' },
  { id: 87, slug: 'balonismo', nome: 'Balonismo', icone: '/categoria-icons/balonismo.svg' },
  { id: 88, slug: 'biathlon', nome: 'Biathlon', icone: '/categoria-icons/biathlon.svg' },
  { id: 89, slug: 'bmx', nome: 'BMX', icone: '/categoria-icons/bmx.svg' },
  { id: 90, slug: 'bocha', nome: 'Bocha' },
  { id: 91, slug: 'bodyboard', nome: 'Bodyboard', icone: '/categoria-icons/bodyboard.svg' },
  { id: 92, slug: 'boiacross', nome: 'Bóia Cross' },
  { id: 93, slug: 'boxe', nome: 'Boxe', icone: '/categoria-icons/boxe.svg' },
  { id: 94, slug: 'bungeejump', nome: 'Bungee Jump', icone: '/categoria-icons/rapel-rope-jump-tirolesa.svg' },
  { id: 95, slug: 'calistenia', nome: 'Calistenia', icone: '/categoria-icons/calistenia.svg' },
  { id: 96, slug: 'cambio', nome: 'Cambio' },
  { id: 97, slug: 'caminhada', nome: 'Caminhada', icone: '/categoria-icons/caminhada.svg' },
  { id: 98, slug: 'canicross', nome: 'Canicross', icone: '/categoria-icons/canicross.svg' },
  { id: 99, slug: 'canionismo', nome: 'Canionismo' },
  { id: 100, slug: 'canoahavaiana', nome: 'Canoa Havaiana', icone: '/categoria-icons/canoa-havaiana.svg' },
  { id: 101, slug: 'canoapolinesia', nome: 'Canoa Polinésia', icone: '/categoria-icons/canoa-polinesia.svg' },
  { id: 102, slug: 'carrinhoderolima', nome: 'Carrinho de Rolimã' },
  { id: 103, slug: 'cicloturismo', nome: 'Cicloturismo', icone: '/categoria-icons/cicloturismo.svg' },
  { id: 104, slug: 'corridadeorientacao', nome: 'Corrida de Orientação' },
  { id: 105, slug: 'corridaemesteira', nome: 'Corrida em Esteira', icone: '/categoria-icons/corrida-em-esteira.svg' },
  { id: 106, slug: 'corridapet', nome: 'Corrida Pet', icone: '/categoria-icons/corrida-pet.svg' },
  { id: 107, slug: 'crosscountry', nome: 'Cross Country', icone: '/categoria-icons/cross-country.svg' },
  { id: 108, slug: 'dirtjump', nome: 'Dirt Jump' },
  { id: 109, slug: 'downhil', nome: 'Downhil' },
  { id: 110, slug: 'duathlon', nome: 'Duathlon', icone: '/categoria-icons/duathlon.svg' },
  { id: 111, slug: 'entregadekit', nome: 'Entrega de Kit' },
  { id: 112, slug: 'escalada', nome: 'Escalada', icone: '/categoria-icons/escalada.svg' },
  { id: 113, slug: 'esgrima', nome: 'Esgrima', icone: '/categoria-icons/esgrima.svg' },
  { id: 114, slug: 'esportessubaquatico', nome: 'Esportes Subaquático' },
  { id: 115, slug: 'esqui', nome: 'Esqui', icone: '/categoria-icons/esqui.svg' },
  ...
  { id: 122, slug: 'futebol7', nome: 'Futebol 7', icone: '/categoria-icons/futebol-7.svg' },
  { id: 123, slug: 'futebolsociety', nome: 'Futebol Society', icone: '/categoria-icons/futebol-society.svg' },
  { id: 124, slug: 'futmesa', nome: 'Futmesa' },
  { id: 125, slug: 'ginasticaacrobatica', nome: 'Ginástica Acrobática', icone: '/categoria-icons/ginastica-olimpica.svg' },
  { id: 126, slug: 'ginasticaaerobica', nome: 'Ginástica Aeróbica', icone: '/categoria-icons/ginastica-olimpica.svg' },
  { id: 127, slug: 'ginasticaolimpica', nome: 'Ginástica Olímpica', icone: '/categoria-icons/ginastica-olimpica.svg' },
  { id: 128, slug: 'ginasticaritmica', nome: 'Ginástica Rítmica', icone: '/categoria-icons/ginastica-olimpica.svg' },
  { id: 129, slug: 'gravel', nome: 'Gravel', icone: '/categoria-icons/gravel.svg' },
  { id: 130, slug: 'halterofilismo', nome: 'Halterofilismo', icone: '/categoria-icons/halterofilismo.svg' },
  { id: 131, slug: 'hiking', nome: 'Hiking', icone: '/categoria-icons/hiking.svg' },
  { id: 132, slug: 'jogosescolares', nome: 'Jogos Escolares' },
  { id: 133, slug: 'kangoo', nome: 'Kangoo' },
  { id: 134, slug: 'kart', nome: 'Kart', icone: '/categoria-icons/kart.svg' },
  { id: 135, slug: 'kettlebellsport', nome: 'Kettlebell Sport', icone: '/categoria-icons/kettlebell-sport.svg' },
  { id: 136, slug: 'kickboxing', nome: 'Kickboxing', icone: '/categoria-icons/kickboxing.svg' },
  { id: 137, slug: 'lacocomprido', nome: 'Laço Comprido', icone: '/categoria-icons/laco-comprido.svg' },
  { id: 138, slug: 'lacoemdupla', nome: 'Laço em Dupla', icone: '/categoria-icons/laco-em-dupla.svg' },
  { id: 139, slug: 'levantamentodepesoolimpico', nome: 'Levantamento de peso olímpico', icone: '/categoria-icons/levantamento-de-peso-olimpico.svg' },
  { id: 140, slug: 'lifesaving', nome: 'Lifesaving' },
  { id: 141, slug: 'livrepodecadastraresporte', nome: 'Livre - Pode cadastrar esporte' },
  { id: 142, slug: 'luta', nome: 'Luta', icone: '/categoria-icons/luta.svg' },
  { id: 143, slug: 'maratonaaquatica', nome: 'Maratona Aquática', icone: '/categoria-icons/maratona-aquatica.svg' },
  { id: 144, slug: 'marchaatletica', nome: 'Marcha Atlética', icone: '/categoria-icons/marcha-atletica.svg' },
  { id: 145, slug: 'mma', nome: 'MMA', icone: '/categoria-icons/mma.svg' },
  { id: 146, slug: 'montanhismo', nome: 'Montanhismo', icone: '/categoria-icons/montanhismo.svg' },
  { id: 147, slug: 'motovelocidade', nome: 'Motovelocidade', icone: '/categoria-icons/motovelocidade.svg' },
  { id: 148, slug: 'mountainbike', nome: 'Mountain Bike', icone: '/categoria-icons/mountain-bike.svg' },
  { id: 149, slug: 'mtb', nome: 'MTB', icone: '/categoria-icons/mtb.svg' },
  { id: 150, slug: 'musculacao', nome: 'Musculação', icone: '/categoria-icons/musculacao.svg' },
  { id: 151, slug: 'natacaocorrida', nome: 'Natação / Corrida', icone: '/categoria-icons/natacao-corrida.svg' },
  { id: 152, slug: 'natacaoempiscina', nome: 'Natação em Piscina', icone: '/categoria-icons/natacao-em-piscina.svg' },
  { id: 153, slug: 'offroad', nome: 'Off-Road', icone: '/categoria-icons/off-road.svg' },
  { id: 154, slug: 'passeiociclistico', nome: 'Passeio Ciclístico', icone: '/categoria-icons/passeio-ciclistico.svg' },
  { id: 155, slug: 'pedal', nome: 'Pedal', icone: '/categoria-icons/pedal.svg' },
  { id: 156, slug: 'pendulo', nome: 'Pêndulo' },
  { id: 157, slug: 'pentatlomoderno', nome: 'Pentatlo moderno', icone: '/categoria-icons/pentatlo-moderno.svg' },
  ...
  { id: 162, slug: 'rapelropejumptirolesa', nome: 'Rapel / Rope jump / Tirolesa', icone: '/categoria-icons/rapel-rope-jump-tirolesa.svg' },
  { id: 163, slug: 'remo', nome: 'Remo', icone: '/categoria-icons/remo.svg' },
  { id: 164, slug: 'rockjump', nome: 'Rock Jump' },
  { id: 165, slug: 'snookersinuca', nome: 'Snooker/Sinuca' },
  { id: 166, slug: 'squash', nome: 'Squash', icone: '/categoria-icons/squash.svg' },
  { id: 167, slug: 'stockcar', nome: 'Stock Car', icone: '/categoria-icons/stock-car.svg' },
  { id: 168, slug: 'supstanduppaddle', nome: 'SUP - Stand Up Paddle', icone: '/categoria-icons/sup-stand-up-paddle.svg' },
  { id: 169, slug: 'taekwondo', nome: 'Taekwondo', icone: '/categoria-icons/taekwondo.svg' },
  { id: 170, slug: 'tiro', nome: 'Tiro', icone: '/categoria-icons/tiro.svg' },
  { id: 171, slug: 'torcidas', nome: 'Torcidas', icone: '/categoria-icons/torcidas.svg' },
  { id: 172, slug: 'torcidasdefutebol', nome: 'Torcidas de Futebol', icone: '/categoria-icons/torcidas-de-futebol.svg' },
  { id: 173, slug: 'trailrun', nome: 'Trail Run', icone: '/categoria-icons/trail-run.svg' },
  { id: 174, slug: 'trainingcamp', nome: 'Training Camp', icone: '/categoria-icons/training-camp.svg' },
  { id: 175, slug: 'treinamentofuncional', nome: 'Treinamento Funcional', icone: '/categoria-icons/treinamento-funcional.svg' },
  { id: 176, slug: 'treinosof', nome: 'Treinos OF', icone: '/categoria-icons/treinos-of.svg' },
  { id: 177, slug: 'trekkingtrilhas', nome: 'Trekking / Trilhas', icone: '/categoria-icons/trekking-trilhas.svg' },
  { id: 178, slug: 'trestambores', nome: 'Três Tambores', icone: '/categoria-icons/tres-tambores.svg' },
  { id: 179, slug: 'ultramaratona', nome: 'Ultramaratona', icone: '/categoria-icons/ultramaratona.svg' },
  { id: 180, slug: 'vaquejada', nome: 'Vaquejada', icone: '/categoria-icons/vaquejada.svg' },
  { id: 181, slug: 'vela', nome: 'Vela', icone: '/categoria-icons/vela.svg' },
  { id: 182, slug: 'velocross', nome: 'Velocross', icone: '/categoria-icons/velocross.svg' },
  { id: 183, slug: 'voleidepraia', nome: 'Vôlei de Praia', icone: '/categoria-icons/volei-de-praia.svg' },
  { id: 184, slug: 'voolivre', nome: 'Voo Livre', icone: '/categoria-icons/voo-livre.svg' },
  { id: 185, slug: 'wakeboard', nome: 'Wakeboard' },
  { id: 186, slug: 'windsurf', nome: 'Windsurf', icone: '/categoria-icons/surf.svg' },
  { id: 187, slug: 'wrestling', nome: 'Wrestling', icone: '/categoria-icons/wrestling.svg' },
];
